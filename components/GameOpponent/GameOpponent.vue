...
import small from '~/assets/img/GameOpponent/small_luna.png'
import medium from '~/assets/img/GameOpponent/medium_luna.jpg'
import high from '~/assets/img/GameOpponent/high_luna.jpg'
