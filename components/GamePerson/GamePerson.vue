...
import small from '~/assets/img/GamePerson/nezuko_small.jpg'
import medium from '~/assets/img/GamePerson/nezuko_medium.jpg'
import high from '~/assets/img/GamePerson/nezuko_high.jpg'
